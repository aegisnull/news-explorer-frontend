          ...
          >
            ...
            <div className="card__container">
              ...
              <h3 className="card__title">
                Japan defence: China threat prompts plan to double military
                spending
              </h3>
              <p className="card__text">
                It is the most dramatic change to Japan's security strategy
                since adopting a pacifist constitution.
              </p>
